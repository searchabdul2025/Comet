...
const PageHeader: React.FC<PageHeaderProps> = ({ title, description, action }) => {
  const actionStyles = "inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-br from-[#D4A843] to-[#B8923A] text-[#101013] font-bold text-sm rounded-xl shadow-[0_4px_14px_rgba(212,175,55,0.3)] hover:scale-[1.02] transition-all";
